...
# 
# 
# ## ----ig.show = 'hold', fig.width=7, fig.height=3.5, fig.fullwidth=T, dev='svg'----
# 
...
## ----fig.show = 'hold', fig.width=5, fig.height=2, fig.fullwidth=T, dev='png', dpi=150----
...
## ----fig.show = 'hold', fig.width=7, fig.height=2, fig.fullwidth=T, dev='png', dpi=150----
