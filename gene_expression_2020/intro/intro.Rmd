...
Most important link: https://konsolerr.github.io/gene_expression_2019/

---

## About the course

* 12 lessons (last is Dec 12th, 2020)
* Most of these lessons are seminars: both lectures and practice on your laptops
* 4 large homeworks


<div class="my-footer"><span>Most important link: https://konsolerr.github.io/gene_expression_2019/</span></div> 
---
...
* Latest R (https://cran.r-project.org/bin/, or just google like "how to install latest R on my favourite operating system")
* Rstudio (https://www.rstudio.com/)
* 4 large homeworks which you will have to defend ( in person (?) )
...
* B is sometimes the case (in the steady state)
...
* We can go to **transcript level** and detect differnt isoforms
...
* What if the organism of intereset is not well-studied?
...
## Spoiler alert: I can talk about this for **days**
...
* We will cover things mostaly in chronological order
