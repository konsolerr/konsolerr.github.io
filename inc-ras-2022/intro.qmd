...
-   [https://www.10xgenomics.com/resources/datasets/1-k-pbm-cs-from-a-healthy-donor-v-3-chemistry-3-standard-3-0-0](https://www.10xgenomics.com/resources/datasets/1-k-pbm-cs-from-a-healthy-donor-v-3-chemistry-3-standard-3-0-0){target="_blank"}

![](images/1k_v3.png)

## Dataset summary

-   [https://cf.10xgenomics.com/samples/cell-exp/3.0.0/pbmc_1k_v3/pbmc_1k_v3_web_summary.html](https://cf.10xgenomics.com/samples/cell-exp/3.0.0/pbmc_1k_v3/pbmc_1k_v3_web_summary.html){target="_blank"}
...
-   Go to <https://drive.google.com/drive/folders/18J9NgzLSLnBjmz_YQsMdOSKKK-lWhSVw?usp=sharing>
-   Download `materials.zip` from the google folder
-   Create new RStudio project
-   Upload the script to your r-studio session
-   Open file `scrna-seq-intro.R`

## Our setup: create project

-  Create new project
-  New Directory -> New Project -> chose a name and folder
...
## Our setup: upload materials

- Upload the materials zip
...
:::
::: {.column width="50%"}
![](images/select_materials.png)
:::
:::


## Our setup: final files
...
-   Only 12566 genes left after filtering (detected in $\leq 10$ cells)
...
-   High numbers of mitochondrial transcripts are associated with apoptotic[^1], stressed[^2] and low-quality cells in general
-   mtDNA% threshold depends highly on the tissue type and the questions being investigated[^3]

[^1]: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8599307/
[^2]: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC126185/
[^3]: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6072887/
...
-   we filtered out 211 droplets due to low quality
